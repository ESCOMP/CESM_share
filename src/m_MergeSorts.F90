...
! !INTERFACE:
    ...
    module m_MergeSorts
      use shr_kind_mod, only : SP=>shr_kind_r4, DP=>shr_kind_r8, I8=>shr_kind_i8
      use shr_abort_mod, only: die=>shr_abort_abort
...
!
! !REVISION HISTORY:
! 24Jun24 added to cesm_share library Jim Edwards (jedwards@ucar.edu)
...
!EOP ___________________________________________________________________
  ...
  character(len=*), parameter :: myname='CESM_SHARE::m_MergeSorts'
